...
class EncoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, embedding_size, hidden_size,
        ...
        #print('self.embedding', len(self.embedding))
        #print('self.embedding', embedding)
...
class RNNTextClassifier(nn.Module):
    ...
    def forward(self, seq, lengths):
        ...
        #print('max_pool1d', maxpool_output.shape)

        avgpool_output = output.permute(0, 2, 1)
        #print('avgpool_output', avgpool_output.shape)
        ...
        '''
        encoder torch.Size([99, 129, 400])
        maxpool_output torch.Size([99, 400, 129])
        max_pool1d torch.Size([99, 400])
        avgpool_output torch.Size([99, 400, 129])
        avgpool_output torch.Size([99, 400])
        '''
